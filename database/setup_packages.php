<?php
/**
 * Run this in browser: http://localhost/CeylonGo/database/setup_packages.php
...
try {
    $db->exec($sql);
    echo "<h2 style='color:green;'>✅ 'packages' table created successfully!</h2>";
    echo "<p><a href='/CeylonGo/'>← Go back to landing page</a></p>";
