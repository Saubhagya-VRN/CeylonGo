...
<head>
  ...
  <style>
    ...
    * {
    ...
    .specialization-option label:hover {
      border-color: #4CAF50;
      background: #f0fff4;
    }

    .specialization-option input[type="radio"]:checked + label {
      border-color: #4CAF50;
      background: linear-gradient(135deg, #e8f5e9 0%, #c8e6c9 100%);
      color: #2e7d32;
    }

    .specialization-option label i {
      font-size: 18px;
      color: #888;
      transition: color 0.3s;
    }

    .specialization-option input[type="radio"]:checked + label i {
      color: #4CAF50;
    }
