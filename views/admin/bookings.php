    ...
    <div class="page-wrapper">
        ...
        <div class="main-content">
            <div class="booking-management">
                ...
                <!-- ══════════════════════════════════
                     SECTION 1 — TRIP BOOKINGS
                ══════════════════════════════════ -->

                <!-- Trip bookings: Search & Filter Form -->
                <form method="GET" action="/CeylonGo/public/admin/bookings">
                    <!-- preserve pkg filters across trip filter submission -->
                ...
                <!-- Package bookings: Search & Filter Form -->
                <form method="GET" action="/CeylonGo/public/admin/bookings">
                    <!-- preserve trip filters across pkg filter submission -->
