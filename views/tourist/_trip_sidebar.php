    ...
    <aside class="trip-sidebar" id="tripSidebar">
      <div class="trip-sidebar-nav">
        <ul>
          ...
          <li<?php echo $sa === 'status' ? ' class="active"' : ''; ?>><a href="<?php echo $b('/tourist/customize-trip?step=11'); ?>"><i class="fa-solid fa-clipboard-list"></i> <span class="sidebar-link-text">Status of Bookings <span class="sidebar-sub">Trip review &amp; submit</span></span></a></li>
