    ...
    <aside class="trip-sidebar" id="tripSidebar">
      <div class="trip-sidebar-nav">
        <ul>
          ...
          <li<?php echo $sa === 'reviews' ? ' class="active"' : ''; ?>><a href="<?php echo $b('/tourist/add-review'); ?>"><i class="fa-solid fa-star"></i> <span class="sidebar-link-text">Reviews <span class="sidebar-sub">Rate your experience</span></span></a></li>
