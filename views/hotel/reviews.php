...
<head>
  ...
  <title>Ceylon Go | Hotel Portal – Reviews</title>
  ...
  <div class="main">
    ...
    <section class="content">
      <div class="profile-actions">
        <div style="margin-right:auto" class="muted">Traveler reviews for your hotel</div>
        <div id="reviewsToast" class="success-banner" style="display:none;">Reply sent successfully</div>
      </div>
