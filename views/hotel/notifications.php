...
<head>
  ...
  <title>Ceylon Go | Hotel Portal – Notifications</title>
...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="nav">
      ...
      <a class="nav-link active" href="/CeylonGo/public/hotel/notifications">Notifications</a>
    </nav>
  </aside>
  ...
  <div class="main">
    ...
    <section class="content">
      <div class="profile-actions">
        <div style="margin-right:auto" class="muted">System and booking alerts</div>
      </div>

      <div id="notificationsListPage" class="notif-cards"></div>
    </section>
  </div>
