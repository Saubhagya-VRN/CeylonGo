...
class GuideReview {
    ...
    public function getReviewsByGuideId($guide_id) {
        try {
            ...
            error_log("Error fetching guide reviews: " . $e->getMessage());
            return [];
        }
    }
     ...
     */
    public function getReviewStats($guide_id) {
        try {
            $query = "SELECT 
            ...
            error_log("Error fetching guide review stats: " . $e->getMessage());
            return [
